    ...
    <div className="md:px-20 px-6 py-10 text-darkgrey ">
      {propertyDetails.map((property) => (
        <div className="flex md:flex-row flex-col justify-between w-full" key={property.id}>
          <div className="flex md:w-3/4 gap-3 flex-col" key={property.id}>
            <div className="flex flex-col space-y-3 ">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="md:text-lg">Maitama, Abuja</span>
              </div>
            </div>
          ...
          <div className="flex space-y-4 md:py-3 w-[300px] md:px-4 flex-col">
            ...
            <div className="flex flex-col border space-y-3 py-3 px-4 border-[#D8D8D8]">
              <div className="flex items-center gap-x-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className=" font-medium text-lg">{property.agent}</span>
                </div>
              </div>
              <Button
                borderRadius="0"
